...
#define JOYSTICK_OUT_EPADDR (ENDPOINT_DIR_OUT | 3)
#define JOYSTICK2_IN_EPADDR  (ENDPOINT_DIR_IN  | 2)
#define JOYSTICK2_OUT_EPADDR (ENDPOINT_DIR_OUT | 4)
// HID Endpoint Size
...
#define GENERIC_EPADDR               (ENDPOINT_DIR_IN | 5)
